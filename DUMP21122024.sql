...
--
-- Host: 127.0.0.1    Database: articulos_de_computacion
-- ------------------------------------------------------
...
INSERT INTO `categoria` (`id_Categoria`, `Nombre`) VALUES (1,'Procesadores'),(2,'Mothers'),(3,'Placa de Video'),(4,'Memorias RAM'),(5,'Almacenamiento'),(6,'Gabinetes'),(7,'Fuentes'),(8,'Monitores'),(9,'Perifericos'),(10,'Conectividad'),(11,'Laptops'),(12,'Impresoras');
...
INSERT INTO `empleados` (`id_Empleado`, `Nombre`, `Apellido`, `Telefono`, `Salario`) VALUES (1,'Santiago','Montiel','2923650689',620000.00),(2,'Felipe','Loyola','2923433431',620000.00);
...
INSERT INTO `orden_de_venta` (`id_Orden`, `id_Cliente`, `id_Empleado`, `Fecha`) VALUES (1,1,1,'2024-10-01'),(2,2,2,'2024-10-01'),(3,3,2,'2024-10-03'),(4,4,2,'2024-10-04'),(5,5,2,'2024-10-06'),(6,6,1,'2024-10-06'),(7,7,1,'2024-10-06'),(8,8,2,'2024-10-07'),(9,9,1,'2024-10-09'),(10,10,1,'2024-10-10'),(11,11,2,'2024-10-11'),(12,12,1,'2024-10-13'),(13,13,1,'2024-10-13'),(14,14,1,'2024-10-15'),(15,15,1,'2024-10-15'),(16,5,2,'2024-10-16'),(17,11,2,'2024-10-17'),(18,2,1,'2024-10-17'),(19,9,1,'2024-10-18'),(20,1,2,'2024-10-20'),(81,1,2,'2024-12-15'),(82,1,2,'2024-12-15'),(83,1,2,'2024-12-15'),(84,1,2,'2024-12-15');
...
INSERT INTO `productos` (`id_Producto`, `Nombre`, `Descripcion`, `Precio`, `Stock`, `Categoria`, `Proveedor`) VALUES (1,'Teclado Mecánico RGB','Teclado mecánico con iluminación RGB personalizable y switches mecánicos.',8999.00,50,9,2),(2,'Mouse Gamer','Mouse ergonómico con DPI ajustable hasta 16000 y botones programables.',5949.00,75,9,3),(3,'Monitor 4K UHD','Monitor 4K UHD de 27 pulgadas con HDR y tasa de refresco de 144Hz.',39999.00,20,8,5),(4,'Laptop Ultrabook','Laptop ultradelgada con procesador Intel i7 y 16GB de RAM.',119999.00,10,11,2),(5,'Disco Duro Externo 1TB','Disco duro externo portátil con USB 3.1 y velocidad de transferencia rápida.',5999.00,100,5,4),(6,'Tarjeta Gráfica RTX 4060','Tarjeta gráfica de última generación con 12GB de VRAM y soporte para ray tracing.',49999.00,15,3,6),(7,'Fuente de Poder 750W','Fuente de poder certificada 80 PLUS Gold con diseño modular.',12999.00,30,7,2),(8,'Audífonos Inalámbricos','Audífonos Bluetooth con cancelación de ruido activa y batería de 24 horas.',9999.00,60,9,4),(9,'Impresora Multifuncional','Impresora 3 en 1 (impresión, escaneo, copia) con conectividad inalámbrica.',14999.00,25,12,3),(10,'Router WiFi 6','Router inalámbrico con soporte WiFi 6 y velocidades de hasta 3000Mbps.',17999.00,40,10,1),(11,'Procesador Intel i9','Procesador Intel Core i9 de décima generación con 10 núcleos y 20 hilos.',49999.00,25,1,1),(12,'Motherboard ATX','Motherboard ATX con soporte para procesadores Intel y AMD, y múltiples ranuras PCIe.',19999.00,30,2,2),(13,'Memoria RAM 16GB','Memoria RAM DDR4 de 16GB con velocidad de 3200MHz.',7999.00,50,4,5),(14,'SSD 1TB','Unidad de estado sólido (SSD) de 1TB con interfaz NVMe y alta velocidad de lectura/escritura.',14999.00,40,5,4),(15,'Gabinete ATX','Gabinete ATX con panel lateral de vidrio templado y soporte para refrigeración líquida.',9999.00,20,6,5),(16,'Fuente de Poder 650W','Fuente de poder certificada 80 PLUS Bronze con diseño semi-modular.',8999.00,35,7,6),(17,'Monitor Full HD','Monitor Full HD de 24 pulgadas con tasa de refresco de 75Hz.',19999.00,50,8,6),(18,'Teclado Inalámbrico','Teclado inalámbrico con batería recargable y diseño ergonómico.',4999.00,60,9,6),(19,'Mouse Inalámbrico','Mouse inalámbrico con sensor óptico de alta precisión y batería recargable.',3999.00,70,9,3),(20,'Router Mesh','Sistema de router mesh con cobertura de hasta 5000 pies cuadrados y soporte para WiFi 6.',29999.00,15,10,1),(21,'Procesador AMD Ryzen 7','Procesador AMD Ryzen 7 de tercera generación con 8 núcleos y 16 hilos.',39999.00,20,1,4),(22,'Motherboard Micro-ATX','Motherboard Micro-ATX con soporte para procesadores Intel y múltiples ranuras PCIe.',14999.00,25,2,2),(23,'Memoria RAM 32GB','Memoria RAM DDR4 de 32GB con velocidad de 3600MHz.',15999.00,30,4,5),(24,'HDD 2TB','Disco duro mecánico (HDD) de 2TB con interfaz SATA y alta capacidad de almacenamiento.',7999.00,50,5,6),(25,'Gabinete Micro-ATX','Gabinete Micro-ATX con diseño compacto y soporte para refrigeración líquida.',7999.00,25,6,5),(26,'Fuente de Poder 850W','Fuente de poder certificada 80 PLUS Platinum con diseño modular.',15999.00,20,7,5),(27,'Monitor Curvo','Monitor curvo de 32 pulgadas con resolución QHD y tasa de refresco de 144Hz.',49999.00,10,8,4),(28,'Teclado Mecánico Compacto','Teclado mecánico compacto con switches mecánicos y retroiluminación RGB.',6999.00,40,9,2),(29,'Mouse Vertical','Mouse vertical ergonómico con sensor óptico de alta precisión.',4999.00,50,9,2),(30,'Extensor de Rango WiFi','Extensor de rango WiFi con soporte para WiFi 6 y velocidades de hasta 1200Mbps.',9999.00,30,10,1),(31,'Procesador Intel i5','Procesador Intel Core i5 de décima generación con 6 núcleos y 12 hilos.',29999.00,30,1,3),(32,'Motherboard Mini-ITX','Motherboard Mini-ITX con soporte para procesadores AMD y múltiples ranuras PCIe.',12999.00,20,2,5),(33,'Memoria RAM 8GB','Memoria RAM DDR4 de 8GB con velocidad de 2400MHz.',3999.00,60,4,6),(34,'SSD 500GB','Unidad de estado sólido (SSD) de 500GB con interfaz SATA y alta velocidad de lectura/escritura.',9999.00,50,5,1),(35,'Gabinete Mini-ITX','Gabinete Mini-ITX con diseño compacto y soporte para refrigeración líquida.',6999.00,15,6,3),(36,'Fuente de Poder 500W','Fuente de poder certificada 80 PLUS Silver con diseño no modular.',6999.00,40,7,4),(37,'Monitor 1080p','Monitor 1080p de 24 pulgadas con tasa de refresco de 60Hz.',14999.00,30,8,1),(38,'Teclado Ergonómico','Teclado ergonómico con diseño dividido y teclas mecánicas.',7999.00,50,9,2),(39,'Mouse para Juegos','Mouse para juegos con sensor óptico de alta precisión y botones programables.',6999.00,60,9,3),(40,'Router Gigabit','Router gigabit con soporte para WiFi 5 y velocidades de hasta 1000Mbps.',7999.00,25,10,5),(41,'Procesador AMD Ryzen 5','Procesador AMD Ryzen 5 de tercera generación con 6 núcleos y 12 hilos.',24999.00,40,1,1),(42,'Motherboard ATX Gaming','Motherboard ATX para gaming con soporte para procesadores Intel y múltiples ranuras PCIe.',17999.00,30,2,4),(43,'Memoria RAM 64GB','Memoria RAM DDR4 de 64GB con velocidad de 3200MHz.',29999.00,20,4,3),(44,'HDD 4TB','Disco duro mecánico (HDD) de 4TB con interfaz SATA y alta capacidad de almacenamiento.',12999.00,30,5,1);
...
-- Dump completed on 2024-12-21 12:08:05
